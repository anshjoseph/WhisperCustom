...
class Client:
    ...
    def __init__(
        ...
        # my code
        self.time_at_sending = []
        self.time_at_receving = []
    ...
    def on_message(self, ws, message):
        ...
        if "segments" in message.keys():
            ...
            self.time_at_receving.append(time.time())
    ...
    def send_packet_to_server(self, message):
        ...
        try:
            ...
            self.time_at_sending.append(time.time())
        except Exception as e:
            print(e)


    def get_avg_timetake(self) -> float:
        return np.average(np.array(self.time_at_receving) - np.array(self.time_at_sending[:len(self.time_at_receving)]))
